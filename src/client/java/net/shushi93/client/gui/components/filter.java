package net.shushi93.client.gui.components;
...
public class filter {
    public static SpriteIconButton filter_btn(int i, Button.OnPress onPress, boolean bl) {
        return SpriteIconButton.builder(Component.translatable("gui.components.filter.filterbtn"), onPress, bl)
                .width(i)
                .sprite(ResourceLocation.fromNamespaceAndPath(ResourceScreening.MOD_ID, "filter"), 18, 18) //TODO add highlighted and disabled images
                .build();
    }
}
